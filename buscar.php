...
<?php
	//Libreria para el control de la sesion
	include_once("func/iniciosesion.php");
?>
...
<button style="position:absolute; top:10px; right:10px;" onclick="location.href='logout.php'" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">Cerrar sesion</button>
<div id="centrado">
